  ...
  <section class="content container-fluid">
    <div class="box box-warning">
      ...
      <div class="box-body" style="padding:20px;">
              ...
              <td>
                <table width="100%">
                  ...
                  <tr>
                    ...
                    <td>, Sebutkan</td>
                    <td>
                      <input value="<?php echo $siswao[9]; ?>" type="text" name="opname_text" class="form-control" style="border-right:none; border-left:none;border-top:none">
                    </td>
                  </tr>
                  <tr>
                    <td>Maag </td>
          ...
          <div class="form-group">
            <h5><b><u>5. Personality Test</u></b></h5>
          </div>
          <div class="form-group">
            <table border="1" style="text-align:center">
              ...
              <?php
                $data = mysqli_query($connect, "SELECT * FROM `siswa_baru6` WHERE id = '$no'");
              ...
              <tr>
                <td>a</td>
                <td width="4%"> <input value="<?php echo $l[0]; ?>" type="text" name="l1" onchange="hitung()"  onchange="myFunction()" id="l1" class="form-control" style="text-align:center"> </td>
                <td>Menyukai kekuasaan</td>
                <td><input value="<?php echo $b[0]; ?>" type="text" name="b1" id="b1"  onchange="bFunction()" class="form-control" style="text-align:center"></td>
                <td>Enthusiastic</td>
                <td><input value="<?php echo $o[0]; ?>" type="text" name="o1" onchange="oFunction()" id="o1" class="form-control" style="text-align:center"></td>
                <td>Perasaan sensitif</td>
                <td><input value="<?php echo $gr[0]; ?>" type="text" name="gr1" onchange="grFunction()" id="gr1" class="form-control" style="text-align:center"></td>
                <td>Menyukai diperintah</td>
              </tr>
              <tr>
                <td>b</td>
                <td> <input value="<?php echo $l[1]; ?>" type="text" name="l2"  onchange="myFunction()" id="l2" class="form-control" style="text-align:center"> </td>
                <td>Suka terlibat</td>
                <td><input value="<?php echo $b[1]; ?>" type="text" name="b2" id="b2"  onchange="bFunction()" class="form-control" style="text-align:center"></td>
                <td>Suka tantangan</td>
                <td><input value="<?php echo $o[1]; ?>" type="text" name="o2" onchange="oFunction()" id="o2" class="form-control" style="text-align:center"></td>
                <td>Loyal</td>
                <td><input value="<?php echo $gr[1]; ?>" type="text" name="gr2" onchange="grFunction()" id="gr2" class="form-control" style="text-align:center"></td>
                <td>Akurat</td>
              </tr>
              <tr>
                <td>c</td>
                <td> <input value="<?php echo $l[2]; ?>" type="text" name="l3"  onchange="myFunction()" id="l3" class="form-control" style="text-align:center"> </td>
                <td>Kuat pendirian</td>
                <td><input value="<?php echo $b[2]; ?>" type="text" name="b3" id="b3"  onchange="bFunction()" class="form-control" style="text-align:center"></td>
                <td>Visioner</td>
                <td><input value="<?php echo $o[2]; ?>" type="text" name="o3" onchange="oFunction()" id="o3" class="form-control" style="text-align:center"></td>
                <td>Tenang</td>
                <td><input value="<?php echo $gr[2]; ?>" type="text" name="gr3" onchange="grFunction()" id="gr3" class="form-control" style="text-align:center"></td>
                <td>Konsisten</td>
              </tr>
              <tr>
                <td>d</td>
                <td> <input value="<?php echo $l[3]; ?>" type="text" name="l4"  onchange="myFunction()" id="l4" class="form-control" style="text-align:center"> </td>
                <td>Membimbing</td>
                <td><input value="<?php echo $b[3]; ?>" type="text" name="b4" id="b4"  onchange="bFunction()" class="form-control" style="text-align:center"></td>
                <td>Suka berbicara</td>
                <td><input value="<?php echo $o[3]; ?>" type="text" name="o4" onchange="oFunction()" id="o4" class="form-control" style="text-align:center"></td>
                <td>Suka rutinitas</td>
                <td><input value="<?php echo $gr[3]; ?>" type="text" name="gr4" onchange="grFunction()" id="gr4" class="form-control" style="text-align:center"></td>
                <td>Mudah diprediksi</td>
              </tr>
              <tr>
                <td>e</td>
                <td> <input value="<?php echo $l[4]; ?>" type="text" name="l5"  onchange="myFunction()" id="l5" class="form-control" style="text-align:center"> </td>
                <td>Kompetitif</td>
                <td><input value="<?php echo $b[4]; ?>" type="text" name="b5" id="b5"  onchange="bFunction()" class="form-control" style="text-align:center"></td>
                <td>Promotor</td>
                <td><input value="<?php echo $o[4]; ?>" type="text" name="o5" onchange="oFunction()" id="o5" class="form-control" style="text-align:center"></td>
                <td>Tidak suka perubahan</td>
                <td><input value="<?php echo $gr[4]; ?>" type="text" name="gr5" onchange="grFunction()" id="gr5" class="form-control" style="text-align:center"></td>
                <td>Praktis</td>
              </tr>
              <tr>
                <td>f</td>
                <td> <input value="<?php echo $l[5]; ?>" type="text" name="l6"  onchange="myFunction()" id="l6" class="form-control" style="text-align:center"> </td>
                <td>Pemecah masalah</td>
                <td><input value="<?php echo $b[5]; ?>" type="text" name="b6" id="b6"  onchange="bFunction()" class="form-control" style="text-align:center"></td>
                <td>Suka popularitas</td>
                <td><input value="<?php echo $o[5]; ?>" type="text" name="o6" onchange="oFunction()" id="o6" class="form-control" style="text-align:center"></td>
                <td>Melimpahkan ke orang lain</td>
                <td><input value="<?php echo $gr[5]; ?>" type="text" name="gr6" onchange="grFunction()" id="gr6" class="form-control" style="text-align:center"></td>
                <td>Berdasarkan fakta</td>
              </tr>

                <td>g</td>
                <td> <input value="<?php echo $l[6]; ?>" type="text" name="l7"  onchange="myFunction()" id="l7" class="form-control" style="text-align:center"> </td>
                <td>Produktif</td>
                <td><input value="<?php echo $b[6]; ?>" type="text" name="b7" id="b7"  onchange="bFunction()" class="form-control" style="text-align:center"></td>
                <td>Menyukai bersenang-senang</td>
                <td><input value="<?php echo $o[6]; ?>" type="text" name="o7" onchange="oFunction()" id="o7" class="form-control" style="text-align:center"></td>
                <td>Menghindari konfrontasi</td>
                <td><input value="<?php echo $gr[6]; ?>" type="text" name="gr7" onchange="grFunction()" id="gr7" class="form-control" style="text-align:center"></td>
                <td>Bertanggung jawab</td>
              </tr>
              <tr>
                <td>h</td>
                <td> <input value="<?php echo $l[7]; ?>" type="text" name="l8"  onchange="myFunction()" id="l8" class="form-control" style="text-align:center"> </td>
                <td>Kaku</td>
                <td><input value="<?php echo $b[7]; ?>" type="text" name="b8" id="b8"  onchange="bFunction()" class="form-control" style="text-align:center"></td>
                <td>Menyukai keragaman</td>
                <td><input value="<?php echo $o[7]; ?>" type="text" name="o8" onchange="oFunction()" id="o8" class="form-control" style="text-align:center"></td>
                <td>Sensitif</td>
                <td><input value="<?php echo $gr[7]; ?>" type="text" name="gr8" onchange="grFunction()" id="gr8" class="form-control" style="text-align:center"></td>
                <td>Perfeksionis</td>
              </tr>
              <tr>
                <td>i</td>
                <td> <input value="<?php echo $l[8]; ?>" type="text" name="l9"  onchange="myFunction()" id="l9" class="form-control" style="text-align:center"> </td>
                <td>Pengambil Keputusan</td>
                <td><input value="<?php echo $b[8]; ?>" type="text" name="b9" id="b9"  onchange="bFunction()" class="form-control" style="text-align:center"></td>
                <td>Spontanitas</td>
                <td><input value="<?php echo $o[8]; ?>" type="text" name="o9" onchange="oFunction()" id="o9" class="form-control" style="text-align:center"></td>
                <td>Membimbing</td>
                <td><input value="<?php echo $gr[8]; ?>" type="text" name="gr9" onchange="grFunction()" id="gr9" class="form-control" style="text-align:center"></td>
                <td>Detail</td>
              </tr>
              <tr>
                <td>j</td>
                <td> <input value="<?php echo $l[9]; ?>" type="text" onchange="myFunction()" name="l10" id="l10" class="form-control" style="text-align:center"> </td>
                <td>Persisten</td>
                <td><input value="<?php echo $b[9]; ?>" type="text" name="b10" id="b10" onchange="bFunction()" class="form-control" style="text-align:center"></td>
                <td>Inspirasional</td>
                <td><input value="<?php echo $o[9]; ?>" type="text" name="o10" id="o10" onchange="oFunction()"  class="form-control" style="text-align:center"></td>
                <td>Pencetus/penggagas</td>
                <td><input value="<?php echo $gr[9]; ?>" type="text" name="gr10" id="gr10" onchange="grFunction()"  class="form-control" style="text-align:center"></td>
                <td>Analitik</td>
              </tr>
              <tr>
                <td></td>
                <td>
                  <input value="<?php echo $a['m']; ?>" style="width:100%" type="text" class="form-control" style="text-align:center" id="l" disabled>
                  <input type="hidden"  id="m" name="m">
                </td>
                <td></td>
                <td>
                <input value="<?php echo $a['n']; ?>" style="width:100%" type="text"  class="form-control" style="text-align:center" id="b" disabled>
                <input type="hidden"  id="n" name="n">
                </td>
                <td></td>
                <td>
                  <input value="<?php echo $a['p']; ?>" style="width:100%" type="text"  class="form-control" style="text-align:center" id="o" disabled>
                  <input type="hidden"  id="p" name="p">
                </td>
                <td></td>
                <td>
                  <input value="<?php echo $a['q']; ?>" style="width:100%" type="text"  class="form-control" style="text-align:center" id="gr" disabled>
